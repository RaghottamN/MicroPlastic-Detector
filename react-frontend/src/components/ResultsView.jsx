...
export default function ResultsView({ image, results, loading, error, onReset }) {
    ...
    return (
        <ScrollStack containerClassName="space-y-0">
            {/* Detection Results Section */}
            <ScrollStackItem className="min-h-screen pb-8">
            ...
            {/* AI Analysis Section */}
            <ScrollStackItem className="min-h-screen bg-dark-primary pt-8">
